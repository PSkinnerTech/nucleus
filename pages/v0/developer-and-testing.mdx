...
This guide provides a step-by-step approach to building the foundational developer tools for Prioris V0.
...
```bash
# Ask Prioris a question
prioris ask "What's the weather today?"
